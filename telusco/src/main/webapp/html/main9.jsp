...
<body class="position-relative">  <!-- 채팅버튼 위치 잡기 위한 클래스 지정 -->
  ...
  <main class="container-fluid">
    <div class="row" style="text-align: center; ;">
        ...
        <div id="photoCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <!-- <img class="img-fluid" src="../images/t4.jpg" alt="Image 1" style="max-width: 100%; max-height: 100%; object-fit: contain;"> -->
                <!-- 포토모달 띄우는 기능 -->
                <img class="img-fluid" type="button" data-bs-toggle="modal" data-bs-target="#modalPhoto" src="../images/celeb/13.jpg" alt="Image 1" style="max-width: 100%; max-height: 100%; object-fit: contain;">
              </div>
            </div>
            <div class="carousel-item">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <img class="img-fluid" src="../images/celeb/11.jpg" alt="Image 1" style="max-width: 100%; max-height: 100%; object-fit: contain;">
              </div>
            </div>
            <div class="carousel-item">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <img class="img-fluid" src="../images/celeb/12.jpg" alt="Image 1" style="max-width: 100%; max-height: 100%; object-fit: contain;">
              </div>
            </div>
            <div class="carousel-item">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <img class="img-fluid" src="../images/celeb/14.jpg" alt="Image 1" style="max-width: 100%; max-height: 100%; object-fit: contain;">
              </div>
            </div>
            <div class="carousel-item">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <img class="img-fluid" src="../images/celeb/15.jpg" alt="Image 1" style="max-width: 100%; max-height: 100%; object-fit: contain;">
              </div>
            </div>
      ...
      <!-- 비디오 갤러리 -->
      <div class="col-lg-4 mt-4">
        <div id="videoCarousel" class="carousel slide" data-interval="100000000000">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <iframe id="video1" src="https://youtube.com/embed/4rBapPlP7KY" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
            <div class="carousel-item">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <iframe id="video2" src="https://www.youtube.com/embed/LR6lwDtPTtc" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
            <div class="carousel-item">
              <div class="ratio ratio-1x1" style="background-color: black; display: flex; align-items: center; justify-content: center;">
                <iframe id="video3" src="https://www.youtube.com/embed/x7-roc1n5nU" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
            <!-- 추가적인 동영상 태그를 원하는 만큼 추가 가능 -->
          </div>
          <!-- 비디오 갤러리 슬라이드 버튼 -->
