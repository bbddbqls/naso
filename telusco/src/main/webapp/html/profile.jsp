    ...
    <div class="row" style="text-align: center; ;">
      ...
      <div class="col-lg-8 container">
        ...
        <div class="row container">
          <div class="col-md-4">
            <img src="../images/icon/person-circle.svg" alt="프로필 사진" style="width: 200px; height: auto;">
          </div>
          <div class="col-md-8 container">
            <div class="row text-lg-start">
            <!-- ProfileController로부터 넘겨받은 데이터가 DTO 형식(필드들이 private임)으로 되어있으므로 게터를 사용해서 데이터를 가져온다. -->
              <h2 class="col-lg-6 fw-bold">${targetProfile[0].getName()}<span class="user-id">(${targetProfile[0].getUserId()})</span></h2>
            ...
            <div class="row text-lg-start">
              <button type="button" class="btn btn-light col-lg-6">프로필 수정(이건 주인만 보이는 곳)</button>
              <div class="col-lg-6"></div>
            </div>
            <div class="row">
              <div class="col-lg-4">
            ...
            <div class="row">
              ...
              <button type="button" class="btn btn-light col-lg-1 px-0">홈</button>
              <button type="button" class="btn btn-light col-lg-2 px-0 ms-1">팔로우</button>
            </div>
          </div>
        </div>
        <hr>
          ...
          <div class="container-fluid">
            ...
            <!-- ========================================================================================== -->
				<c:choose>
					...
					<c:otherwise>
						<c:forEach var="targetProfile" items="${targetProfile }">
					        <!-- 아래 a 태그는 클릭시 해당 계정 아이디 값을 "userId"에 담아서 prfCtrl(ProfileController)로 넘김 -->
					        <div class="col photo-item" data-bs-toggle="modal" data-bs-target="#detailPhoto${targetProfile.getPostNum()}"><img class="" src="../images/celeb/14.jpg" alt=""></div>
			                <!-- from yubin 포토모달에서 상세보기 (프로필 화면에서 게시물 클릭시)-->
					        <div class="modal fade" id="detailPhoto${targetProfile.getPostNum()}" tabindex="-1" aria-labelledby="detailPhoto${targetProfile.getPostNum()}Label" aria-hidden="true">
					          <div class="modal-dialog modal-dialog-scrollable modal-xl">
					            <div class="modal-content">
					              <div class="modal-header">
					                <h5 class="modal-title" id="detailPhoto${targetProfile.getPostNum()}Label">Profile modal</h5>
					                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					              </div>
					              <div class="modal-body row select-modal">
					                <div class="container col-lg-6 select-modal-img">
					                ...
					                <div class="container col-lg-6 select-modal-information text-lg-start">
					                  <div class="container-fluid select-modal-user">
					                    <div class="user-profile-img">
					                      <img src="../images/icon/person-circle.svg" alt="">
					                    </div>
					                    <div class="user-profile-name">
					                      <p>${targetProfile.getName()}</p>
					                    </div>
					                  </div>
					                  <div class="container-fluid select-modal-text">
					                    <p>${targetProfile.getContent()}</p>
					                  </div>
					                  <div class="container-fluid select-modal-buttons">
					                    <img src="../images/main/heart.png" alt="">
					                    <p>0</p>
